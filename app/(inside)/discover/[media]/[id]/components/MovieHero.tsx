...
import { FilmIcon, StarIcon, CurrencyDollarIcon, LanguageIcon, BuildingOffice2Icon, GlobeAltIcon, PlusIcon } from '@heroicons/react/24/solid';
...
export function MovieHero({ media }: { media: Movie }) {
